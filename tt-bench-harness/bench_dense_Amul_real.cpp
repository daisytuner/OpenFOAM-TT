...
int main(int argc, char* argv[]) {
    ...
    __daisy_metadata_t metadata1 = {
        ...
        .sdfg_file = "/tmp/DOCC/000000/123456789/sdfg_0.json",
        .element_id = 101,
    ...
    __daisy_metadata_t metadata2 = {
        ...
        .column_begin = 0,
        .column_end = 0,
        .sdfg_name = "__daisy_instrumentation_test_1",
        .sdfg_file = "/tmp/DOCC/000000/123456789/sdfg_1.json",
        .element_id = 102,
        .element_type = "h2d_transfer",
        .target_type = "TENSTORRENT",
    ...
    __daisy_metadata_t metadata3 = {
        ...
        .column_begin = 0,
        .column_end = 0,
        .sdfg_name = "__daisy_instrumentation_test_2",
        .sdfg_file = "/tmp/DOCC/000000/123456789/sdfg_2.json",
        .element_id = 102,
        .element_type = "map",
        .target_type = "TENSTORRENT",
        .loopnest_index = 0,
    ...
    __daisy_metadata_t metadata4 = {
        ...
        .column_begin = 0,
        .column_end = 0,
        .sdfg_name = "__daisy_instrumentation_test_3",
        .sdfg_file = "/tmp/DOCC/000000/123456789/sdfg_3.json",
        .element_id = 103,
